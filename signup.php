...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$exists = "SELECT * FROM `store` WHERE username = '$username'";
	...
	else
	{
		...
		if(($password == $cpassword))
		{
			...
			$sql = "INSERT INTO `store` ( `uid`, `Username`, `Password`, `Date`, `sinfo`) VALUES ('$uid','$username', '$password', current_timestamp(), 'Unentered')";
			...
			<div class="user signinBx">
				<div class="formBx">
					<form action="signup.php" method="post">
						...
						<p class="signup">Already have an Account ???<a href="/snacks/login.php">Sign In.</a></p>
						<?php 
						if ($showAlert) {
